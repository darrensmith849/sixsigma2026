...
const navItems: NavItem[] = [
  ...
  { label: "Services", href: "/services" },
  {
    ...
    children: [
      ...
      { label: "Green Belt (Core)", href: "/courses/core-green-belt-classroom" },
      { label: "Green Belt (Lean)", href: "/courses/lean-green-belt-classroom" },
      { label: "Green Belt (DMAIC)", href: "/courses/dmaic-green-belt-classroom" },
      { label: "Black Belt (Lean)", href: "/courses/lean-black-belt-classroom" },
      { label: "Black Belt (DMAIC)", href: "/courses/dmaic-black-belt-classroom" },
      { label: "5S", href: "/courses/5s-classroom" },
      { label: "Kaizen", href: "/courses/kaizen-classroom" },
