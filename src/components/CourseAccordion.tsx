      ...
      <div className="space-y-2">
        {sections.map((section, i) => {
          ...
          return (
            <div
              key={section.heading}
              className="rounded-lg overflow-hidden bg-light-grey"
            >
              <button
                onClick={() => toggle(i)}
              ...
              >
                ...
                <span
                  className="w-7 h-7 shrink-0 rounded-full bg-green flex items-center justify-center transition-transform"
                  style={{
